...
```{r}
get.demand.plot(DATABASE, MONGO_URI, params$filter, datafile=DATA_FILE)
```
...
```{r}
get.revenue.potential.plot(DATABASE, MONGO_URI, params$filter, datafile=DATA_FILE)
```
...
get.supply.plot(DATABASE, MONGO_URI, params$filter, datafile=DATA_FILE)
```
...
get.competition.plot(DATABASE, MONGO_URI, params$filter, datafile=DATA_FILE)
```
...
```{r}
get.market.entry.data.2.plot(DATABASE, MONGO_URI, params$filter, datafile=DATA_FILE)
```
...
```{r}
get.overall.score.plot(DATABASE, MONGO_URI, params$filter, datafile=DATA_FILE)
```
