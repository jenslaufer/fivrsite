...
reported.vs.reviewed.revenue.plot <- example.top.seller.revenue.df %>%
  ...
  labs(title="Fiverr Top Star's Revenue", subtitle = 'Reported Revenue vs Real Reviewed Revenue')+
  bbc_style()
...
We are in a world of self-marketing, everybody wants to get on page one with his story to push his business. Why not cheat a bit with the numbers? But we have the data from Fiverr, we can evaluate if the numbers are right.

First, I identified the usernames of the sellers, which was not difficult. Then I extracted the data for the gigs these sellers are offering. You can retrieve the price, and you can see the number of reviews, which lets you calculate a name I would call "reviewed revenue". Afterwards, you can add up the revenue for all gigs somebody is offering.
...
The reviewed revenue of David Feldman, Joel Young and Alex Fasulo is lower than the income reported in the stories. The reviewed revenue is by a factor between 0.3 and 0.5 lower. On the other hand, for is the reviewed revenue for Redd Horrocks, Levi Newman and Charmaine Pocek by a factor between 1.3 and 1.8 higher than the reported income.

So our first impression could be: We caught all of them on lying and David, Joel and Alex are terrible exaggerators.

This view is a bit too simplified. I was curious what's the rated order ratio is on Fiverr. I found a post on the Fiverr forum on it: [What is your Rated Orders percentage?](https://forum.fiverr.com/t/what-is-your-rated-orders-percentage/143919/6) and I asked the sellers on Reddit for their [rated order ratio](https://www.reddit.com/r/Fiverr/comments/b8h1pn/help_what_is_your_rated_order_ratio/). People report ratios at around 80%, which seems very high to me. I decided to take a value of about 50%. Assuming this ratio the numbers of Alex, Joel and David seem realistic. It means on the other hand that Redd, Levi and Charmaine are making much money than they reported. 
...
What gigs are making this amount of money? We look for the top3 gigs from each of our friends. 
...
This unbelievable that one single gig is making over 500,000.

But is this realistic to everybody of us?

## Can everybody be a superstar?

How realistic is it to make millions with one single Gig?

I analysed `r dim(all.gigs)[1]` Gigs in `r num.niches` niches. Are there other gigs that made over a 100,000 reviewed revenue.

```{r}
other.top.seller.gigs.plot
```

This shows you that there are more people a ton of money on Fiverr.
...
You can see that the majority of Gigs made less than 1,000. Reaching between 1,000-10,000 is possible, but every over that is quite hard to achieve

## Conclusion

We answered the question if it is possible to make 1,0000,000 on Fiverr. We could prove that it is possible and that there are more superstars on Fiverr who are making a lot of money. But we also learned earning these amounts is a tough job.
